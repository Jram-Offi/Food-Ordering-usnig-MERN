...
const Items = (props) => {
    ...
    const handleClickOpen = (event) => {
        ...
        axios
            .post('http://localhost:5000/vendor/finditem', newUser)
            .then((res) => {
    ...
    const onSubmit = (event) => {
        ...
        console.log(newUser)
        axios
            .post('http://localhost:5000/vendor/edititem', newUser)
            .then((res) => {
                console.log(res.data)
    ...
    const onDelete = (event) => {
        ...
        axios
            .post('http://localhost:5000/vendor/deleteitems', newUser)
            .then((res) => {
                if (res.data.status === "success") {
                    alert("Item Deleted!")
                    window.location.reload();
    ...
    useEffect((event) => {
        ...
        axios
            .post('http://localhost:5000/vendor/viewitems', newUser)
            .then((res) => {
                // console.log(res.data)
                setRows(res.data);
                setItemName(res.data.name);
