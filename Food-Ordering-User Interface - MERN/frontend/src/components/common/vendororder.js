...
const VendorOrder = (props) => {
  ...
  const onReject = (event) => {
    ...
    axios
      .post("http://localhost:5000/vendor/changestatus", newUser)
      .then((response) => {
  ...
  const onNext = (event) => {
    ...
    axios
      .post("http://localhost:5000/vendor/nextstage", newUser)
      .then((res) => {
        // setUsers(response.data);
  ...
  useEffect((event) => {
    ...
    axios
      .post("http://localhost:5000/vendor/vendororder", newUser)
      .then((response) => {
        setUsers(response.data);
        console.log(response)
        //setSortedUsers(response.data);
