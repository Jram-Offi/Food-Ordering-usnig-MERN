...
export default class Register extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/vendor/register', newUser)
      .then(res => {
        console.log(res.data)
        alert("Registered!")
      })
  ...
  render() {
    ...
    <div >
      ...
      <div class="form-check">
        <input class="form-check-input" type="radio" id="customer" name="usertype" value="customer" onChange={this.onChangeUsertype}/>
        <label class="form-check-label" for="customer">
        Customer
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="radio" id="vendor" name="usertype" value="vendor" onChange={this.onChangeUsertype} />
