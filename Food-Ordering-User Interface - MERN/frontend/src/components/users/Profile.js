  ...
  const onSubmit = (event) => {
    ...
    if (localStorage.getItem('edit') === '1') {
      ...
      if (type === 'customer') {
        ...
        console.log(newUser)
        axios
          .post('http://localhost:5000/user/profile', newUser)
          .then((res) => {
      ...
      if (type === 'vendor') {
        ...
        axios
          .post('http://localhost:5000/vendor/profile', newUser)
          .then((res) => {
            console.log(res.data)
            if (res.data.status === "success") {
              console.log("yo!")
...
/*export default class Profile extends Component {
  ...
  onSubmit() {
    if (type === 'customer') {
      ...
      axios.post('http://localhost:5000/user/profile', newUser)
        .then(res => {
      ...
      axios.post('http://localhost:5000/profile', newUser)
        .then(res => {
          console.log(res.data)
          alert("Registered!")
        })
  ...
  /*useEffect(() => {
    ...
    if (type === 'customer') {
      axios
        .get("http://localhost:5000/profile") // unimplemented
        .then((res) => {
